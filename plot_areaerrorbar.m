...
% ----------------------------------------------------------------------- %
function plot_areaerrorbar(data, options,time)
    % Default options
    if(nargin<2)
    ...
    if(~isfield(options,'color_area'))
        options.color_area = round(options.color_line.*255+0.2.*([255 255 255]-options.color_line.*255))./255;
    end
